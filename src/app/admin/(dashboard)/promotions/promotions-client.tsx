...
import { MoreHorizontal, Plus, Edit, Trash2, Tag, Percent, DollarSign } from 'lucide-react'
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <div className="relative">
                  <Input type="number" value={discountValue} onChange={e => setDiscountValue(e.target.value)} className={isPercentage ? "pr-8" : "pl-8"} />
                  {isPercentage ? (
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} className="bg-gray-900 text-white">Save Promotion</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
