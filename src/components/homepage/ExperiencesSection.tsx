        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 relative">
          ...
          <div className="w-full lg:w-1/2 z-20 relative pt-12 lg:pt-0">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-7xl font-argine font-medium leading-[0.9] tracking-tighter mb-8 text-zinc-900">
                {settings.title}
              </h2>
              
              <div 
                className="text-lg md:text-xl text-zinc-500 font-light leading-relaxed mb-10 max-w-md prose prose-zinc prose-p:font-light"
                dangerouslySetInnerHTML={{ __html: settings.description }}
              />
              
              <Button size="lg" className="group bg-zinc-900 text-white hover:bg-zinc-800 h-14 px-8 rounded-full font-medium tracking-wide transition-all duration-500 w-fit shadow-xl shadow-zinc-200">
