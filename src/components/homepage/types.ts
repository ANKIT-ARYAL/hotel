...
export const defaultHomepageSettings: HomepageSettings = {
  ...
  hero: {
    ...
    subtitle: 'Step into a world of refined beauty and uncompromising comfort. Your extraordinary journey begins the moment you arrive.',
    videoUrl: 'https://videos.pexels.com/video-files/853889/853889-hd_1920_1080_25fps.mp4',
    backgroundImageFallback: 'https://images.unsplash.com/photo-1542314831-c53cd4b85d85?q=80&w=3270&auto=format&fit=crop',
  ...
  culinary: {
    ...
    description: 'Embark on a gastronomic journey with our award-winning chefs. From authentic local flavors to exquisite international cuisine, every dish is a masterpiece designed to delight your senses.',
  ...
  spaWellness: {
    isVisible: true,
    title: 'Spa & Wellness',
    description: 'Rejuvenate your body and soul in our tranquil sanctuary. Offering personalized treatments, state-of-the-art facilities, and holistic therapies to restore your inner balance.',
  ...
  experiences: {
    ...
    description: 'Immerse yourself in curated activities designed to elevate your stay. From private yacht charters to exclusive wine tastings, every moment is crafted to perfection.',
  ...
  ourStory: {
    ...
    description: 'Since 1924, Hotel Luxury has been the pinnacle of extraordinary hospitality. Our walls hold the stories of dignitaries, artists, and lovers who have sought refuge in our timeless embrace.',
