    ...
    <div className="relative min-h-[100dvh] w-full flex flex-col justify-center items-center overflow-hidden py-24 px-6 md:px-12 lg:px-24">
      ...
      <div className="relative z-20 w-full max-w-5xl mx-auto flex flex-col items-center text-center gap-12 mt-20">
        ...
        <motion.h2 
          ...
          className="font-argine text-white text-6xl md:text-8xl lg:text-[9rem] leading-[0.85] tracking-tighter"
        >
          {settings.title}
        </motion.h2>
        ...
        >
          <div 
            className="text-white/80 max-w-2xl font-light prose prose-invert prose-p:text-2xl prose-p:leading-relaxed text-center"
            dangerouslySetInnerHTML={{ __html: settings.description }}
          />
          
          <Button size="lg" className="group bg-white text-black hover:bg-zinc-200 h-20 px-12 text-lg rounded-full font-medium tracking-wide transition-all duration-500 w-fit mt-4">
