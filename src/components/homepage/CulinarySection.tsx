      ...
      <div className="relative z-20 w-full max-w-[1600px] mx-auto flex flex-col items-end text-right gap-8">
        ...
        <div className="max-w-3xl flex-1 flex flex-col items-end">
          <motion.h2 
            ...
            className="font-argine text-white text-5xl md:text-7xl lg:text-[7rem] leading-[0.9] tracking-tighter mb-8"
          >
            {settings.title}
          </motion.h2>
          ...
          >
            <div 
              className="text-white/80 max-w-lg text-xl font-light prose prose-invert text-right"
              dangerouslySetInnerHTML={{ __html: settings.description }}
            />
            
            <Button size="lg" className="group bg-white text-black hover:bg-zinc-200 h-14 px-8 rounded-full font-medium tracking-wide transition-all duration-500 w-fit mt-4">
